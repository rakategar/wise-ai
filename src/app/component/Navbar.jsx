...
export default function Navbar() {
  ...
  return (
    <div
      className={`navbar bg-base-100 rounded-lg gap-8 text-black   transition-transform duration-1000 z-[11] ${
    ...
    >
      ...
      <div className=" ">
        {session ? (
          <a
            className="btn w-24 px-4 bg-secondary hover:bg-sky-700 text-white"
            href="/dashboard"
          >
            Dashboard
          </a>
