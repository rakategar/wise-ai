"use client"
import { Bell, Calendar, CaretDown, Gear, SignOut, User } from '@phosphor-icons/react';
  ...
  return (
    <div className="flex items-center justify-center min-h-screen" style={{ backgroundColor: '#F7F7F7' }}>
      <div className='left-0 h-screen w-72 p-2 flex flex-col items-center gap-1 fixed top-8'>
        ...
        <div className={`w-56 h-10 hover:bg-gray-200 rounded-lg flex items-center p-1 gap-2 transition-all duration-300 ${openDropdown ? 'mt-2' : 'mt-0'}`}>
          <Image 
      ...
      <div className='bg-[#ECF2FA] w-[1400px] h-[795px] rounded-lg flex flex-col fixed right-7 p-4 gap-4 '>
        ...
        <div className='flex  items-center justify-end gap-4'>
          ...
          <div className='bg-[#F7F7F7] w-52 h-10 rounded-full flex justify-end items-center'>
              <p className='text-black w-42 flex justify-center mr-9'>{username}</p>
            ...
            <div className='bg-[#F7F7F7] w-16 h-9 btn btn-circle flex items-center justify-center mr-2 ' onClick={handleLogout}>
              <SignOut size={20}  weight="fill" className='text-error' />
            </div>

        </div>
          <div className='flex flex-row justify-between items-center '>
            <h1 className='text-black font-bold text-2xl'>Selamat Siang, {username}</h1>
            <div className='flex flex-row justify-center items-center gap-2 mr-2'>
              <div className='flex flex-col justify-start  text-left'>
                ...
                <p className='text-xs text-black opacity-70 '>Selasa, 29 Agustus 2024</p>
              </div>
            ...
            <div className='flex flex-col bg-[#F7F7F7] w-[819px] h-[233px] p-4 gap-4'>
              <div className='flex flex-row items-center justify-between'>
                <div className='flex flex-row items-center'>
                  <p className='text-black text-xs flex  mr-8'>Paket <br/> saat ini</p>
                  <h1 className='text-black text-xl font-bold flex justify-start mr-2'>Starter</h1>
                  <p className='text-white bg-black text-xs flex items-center justify-start rounded-full p-1 px-2 '>free</p>
                </div>
                <div className='flex flex-col  text-right'>
                  <p className='text-xs text-black opacity-40 justify-end '>Tanggal hari ini</p>
                  <p className='text-xs text-black opacity-70 justify-end'>Selasa, 29 Agustus 2024</p>
                </div>
              </div>
              <div className='flex flex-row items-center justify-between'>
                <div className='flex flex-row items-center'>
                  ...
                  <div className='flex flex-col'>
                    <progress className="progress w-56 progress-error" value="85" max="100"></progress>
                    <p className='text-xs text-black opacity-40 justify-end '>8 dari 10 device yang tersedia</p>
                  </div>
                </div>
                <div className='flex flex-col  text-right'>
                  <p className='text-xs text-black opacity-70 justify-end'>Upgrade paket untuk meningkatkan <br/> batasan fitur yang ada</p>
                </div>
              </div>
              <div className='flex flex-row items-center justify-between'>
                <div className='flex flex-row items-center'>
                  <p className='text-black text-xs flex  mr-8'>Device</p>
                  <div className='flex flex-col'>
                    <progress className="progress w-56 progress-success" value="30" max="100"></progress>
                    <p className='text-xs text-black opacity-40 justify-end '>5 dari 100 kontak yang tersedia</p>
                  </div>
                </div>
                <div className='flex flex-col  text-right'>
                  <p className='text-xs text-secondary border-secondary   w-52 h-8  items-center justify-center btn btn-outline btn-secondary'>Upgrade Paket</p>
                </div>
              </div>
                    <p className='text-xs text-black opacity-40 flex justify-center items-center mt-6 '>Tampilkan kapasitas fitur lainnya</p>
            </div>
            <div className='flex flex-col bg-[#F7F7F7] w-[540px] h-[233px] rounded-lg p-4 gap-1'>
              ...
              <div className='flex flex-row w-full h-10 bg-[#ECF2FA] rounded-lg items-center gap-4 justify-between'>
                <div className='flex-row flex items-center gap-4'>
                  ...
                  <div className='flex flex-col  text-left'>
                    ...
                    <p className='text-black text-xs text-left'>Hai apa kabarmu hari ini? Semoga...</p>
                  </div>
                </div>

                <p className='text-white bg-secondary text-xs flex items-center justify-end rounded-full p-1 px-2 mr-4 '>Terkirim</p>
              </div>
              ...
              <div className='flex flex-row w-full h-10 bg-[#ECF2FA] rounded-lg items-center gap-4 justify-between'>
                <div className='flex-row flex items-center gap-4'>
                  ...
                  <div className='flex flex-col  text-left'>
                    <p className='text-black text-xs font-bold text-left'>Ihsanul Aftar</p>
                    <p className='text-black text-xs text-left'>Hai apa kabarmu hari ini? Semoga...</p>
                  </div>
                </div>
              ...
              <Link href={''} className='text-xs text-secondary  flex justify-center items-center mt-4 '>Tampilkan lainnya</Link>
          ...
          <div className='flex flex-col bg-[#F7F7F7] w-full h-full rounded-lg p-4 gap-1'>
            ...
            <div className='flex flex-col border-gray-400 border w-[400px] h-[183px] rounded-lg p-4 gap-1'>
              <p className='text-black  font-bold mb-2 '>Ringkasan Hari Ini</p>
              <div className='flex flex-row items-center justify-between'>
              <div className="dropdown dropdown-bottom">
                  <div tabIndex={0} role="button" className="btn m-1 flex flex-row w-52 justify-between">
            ...
            <div className='flex flex-row justify-between items-center border-gray-400 border w-full h-[183px] rounded-lg p-4 gap-1'>
              <div className='flex flex-col justify-between'>
              <p className='text-black  font-bold mb-10 '>Total Statistik Pesan</p>

              <div className='flex flex-row'>
                <div className='flex text-left flex-col text-black justify-center ml-2'>
                  <p className='text-black opacity-40 text-xs'>Total Pesan Keluar</p>
                  <p className=' font-bold'>48</p>
                </div>
                <div className='flex text-left flex-col text-black justify-center ml-2'>
                  <p className='text-black opacity-40 text-xs'>Total Pesan Gagal</p>
                  <p className=' font-bold'>8</p>
                </div>
              </div>
                <div className='flex text-left flex-col text-black justify-center ml-2'>
                  <p className='text-black opacity-40 text-xs'>Total Pesan Masuk</p>
                  <p className=' font-bold'>24</p>
                </div>
              </div>
                <div className="radial-progress text-primary mr-8  text-bold " style={{ "--value": 70 }} role="progressbar">
                  70%
                </div>
            </div>
            </div>
            <div className='flex flex-col justify-between  border-gray-400 border w-full h-[183px] rounded-lg px-4 py-8 gap-1 mt-2'>
              <div className='flex flex-row gap-8 items-center'>
                ...
                <div className='bg-gray-200 w-32 h-12  rounded-lg p-1'>
                  <div className='flex text-left flex-col text-black justify-center ml-2'>
                    <p className='text-black opacity-40 text-xs'>Rata-rata harian</p>
                    <p className=' font-bold'>7</p>
                  </div>
                </div>
                <div className='bg-gray-200 w-32 h-12  rounded-lg p-1'>
                  <div className='flex text-left flex-col text-black justify-center ml-2'>
                    <p className='text-black opacity-40 text-xs'>Bulan ini</p>
                    <p className=' font-bold'>23</p>
                  </div>
                </div>
                <div className='bg-gray-200 w-32 h-12  rounded-lg p-1'>
                  <div className='flex text-left flex-col text-black justify-center ml-2'>
                    <p className='text-black opacity-40 text-xs'>Rata-rata waktu</p>
